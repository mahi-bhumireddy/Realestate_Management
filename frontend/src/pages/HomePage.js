    ...
    <>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="content">
            ...
            <ul>
              <li>We are students at PTU, dedicated to offering you a platform where you can explore, buy, sell, and Advertise properties.</li>
      ...
      <section className="footer">
        <div className="box-container">
          ...
          <div className="box">
            <h3>contact info</h3>
            <a href="#!">+91 9492760520</a>
            <a href="#!">mahi.bhumireddy@gmail.com</a>
            <a href="#!">Puducherry, 605014</a>
          </div>
        ...
        <div className="credit">
          created by <span>Mahidhar, Sai madhav, Shiva Shankar</span> | All rights are reserved!
        </div>
      </section>
    </>
  );
